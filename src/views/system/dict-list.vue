<template>
    <div class="app-container">
        <div class="treeHead">
            <div><h2>字典列表</h2></div>
            <div>
                <el-select v-model="queryForm.code" filterable clearable placeholder="请选择字典分类"
            ...
            <div>
                <el-button size="medium" type="success" @click="fetchData"
                >查询
                </el-button
                >
                <el-button size="medium" type="primary" @click="showAddDialog"
                >添加字典
                </el-button
                >
                <el-button size="medium" @click="reCacheToRedis"
                >缓存字典到Redis
                </el-button
                >
            </div>
        ...
        >
            <el-form ref="addForm" label-width="120px">
                ...
                <el-form-item label="分类code：" v-show="addForm.editType === 1">
                ...
                <el-form-item label="分类code：" v-show="addForm.editType === 2">
                    <el-input v-model="addForm.code"></el-input>
                </el-form-item>
                <el-form-item label="分类描述：" v-show="addForm.editType === 2">
        ...
        >
            <el-form ref="updateForm" label-width="120px">
                ...
                <el-form-item label="分类code：" v-show="updateForm.editType === 1">
                    <el-select v-model="updateForm.code"
                               filterable
                               clearable
                               placeholder="请选择字典分类"
                               style="width:100%;"
                ...
                <el-form-item label="分类code：" v-show="updateForm.editType === 2">
                    <el-input v-model="updateForm.code"></el-input>
                </el-form-item>
                <el-form-item label="分类描述：" v-show="updateForm.editType === 2">
                    <el-input v-model="updateForm.desc"></el-input>
                </el-form-item>
                <el-form-item label="字典名称：">
    ...
    export default {
        ...
        methods: {
            ...
            chooseAddFormCategory(val) {
                let select = this.category.find(item => {
